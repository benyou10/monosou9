...
import logo from 'C:/xamppp/htdocs/monoSou9-webApp/react/public/logo.png'
    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        ...
        <div class="hidden sm:flex sm:items-center">
          ...
          <a href="/creators" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Creators</a>
          <a href="/About" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">About</a>
          <a href="contact" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Contact</a>
          <a href="/premium" class="text-gray-800 text-sm font-semibold hover:text-purple-600">Premium</a>

        </div>

        <div class="hidden sm:flex sm:items-center">
          <a href="/login" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
      ...
      <div class="block sm:hidden bg-white border-t-2 py-2">
        <div class="flex flex-col">
          ...
          <a href="/creators" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Creators</a>
          ...
          <a href="/premium" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Premium</a>
